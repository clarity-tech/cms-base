...
use ClarityTech\Cms\Filament\Admin\Resources\TaxonomyResource\Pages;
use ClarityTech\Cms\Forms\TaxonomyForm;
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('name')
                    ->searchable(),
                Tables\Columns\TextColumn::make('type_of')
                    ->searchable(),
